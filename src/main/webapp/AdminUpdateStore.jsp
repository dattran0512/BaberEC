...
<body>
	...
	<div class="container">
  	<h2>Sửa cửa hàng</h2>
    <form action="AdminUpdateStore">
    <div class="form-group">
      <label for="text">ID</label>
      <input type="text" class="form-control" id="idStore" value="${cuahang.id}" name="id" readonly required>
    </div>
    <div class="form-group">
      <label for="text">Tên cửa hàng</label>
      <input type="text" class="form-control" id="storeName" value="${cuahang.name}" name="name" required>
    </div>
    ...
    <div class="form-group">
      <label for="text">Chọn Quận\Huyện</label>
		   <select id="selectQH" name="idQuanHuyen" required >
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="detailAdd" value="${cuahang.address}"  name="detailAdd" required>
    </div>
...
<script>
	document.getElementById('selectThanhPho').value=sessionStorage.getItem("idTP");
	 function selectTP(selectObject){
		...
		window.location.href='AdminUpdateStore_SelectTP?idTP='+id;
		}
