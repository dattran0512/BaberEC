...
/**
 * Servlet implementation class AdminAddStore_SelectTP
 */
@WebServlet("/AdminAddStore_SelectTP")
public class AdminAddStore_SelectTP extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ThanhPhoDAO thanhphoDAO = new ThanhPhoDAO();         
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminAddStore_SelectTP() {
        super();
