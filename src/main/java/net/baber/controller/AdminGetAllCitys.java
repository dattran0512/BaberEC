...
/**
 * Servlet implementation class AdminGetAllCitys
 */
@WebServlet("/AdminGetAllCitys")
public class AdminGetAllCitys extends HttpServlet {
	private static final long serialVersionUID = 1L;
	ThanhPhoDAO thanhphoDAO = new ThanhPhoDAO();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminGetAllCitys() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("AdminCity.jsp").forward(request, response);
	}
